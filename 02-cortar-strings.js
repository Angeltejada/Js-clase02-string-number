...
console.log('usando slice para cortar alreves: ' , texto.slice(-7));
console.log('usando slice para cortar alreves: ' , texto.slice(-13, -6));

//reemplazar palabras:
console.log('reemplazar la primera ocurrencia: ' , texto.replace('sarasa', 'gatitos'));
//g es global (todas las ocurrencias), i es insensitive (mayusc/minusc).Sin la g, reemplaza solo elprimero.Sin la i, si hay mayusculas/minusculas no las reemplaza
...
//no es lo mas usado, pero el locale  tiene en cuenta el idioma del usuario (si les hace cosas rara con los acentos pueden usar esto)
